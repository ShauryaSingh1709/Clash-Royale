"""
==========================================================================
🏆 CLASH ROYALE DECK ANALYZER - Configuration Settings
==========================================================================
...
class Config:
    ...
    Contains all settings, paths, and constants used across the app.
    ...
    CORS_ORIGINS: list = ["*"]  # Allow all origins (change in production)
